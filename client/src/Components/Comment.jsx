...
const Comment = () => {
  return (
    <section className="bg-slate-600 py-8 lg:py-16 antialiased mt-6 rounded-xl">
  <div className="max-w-2xl mx-auto px-4">
    ...
    <form className="mb-6">
        ...
        <button type="submit"
            className="inline-flex items-center py-2.5 px-4 text-xs font-medium text-center bg-slate-500 text-white bg-primary-700 rounded-lg focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800">
            Post comment
        </button>
    </form>
